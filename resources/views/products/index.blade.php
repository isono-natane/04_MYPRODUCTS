...
<div class="row">
    <div class="col-md-4 col-lg-3  mb-4">
        <form class="card mb-4" action="{{ route('home') }}" method="get">
            ...
            <dl class="search-box card-body mb-0">
                ...
                <dd>
                    <select name="sort" class="form-select">
                        ...
                        <option value="2"{{ Request::get('sort') == 'price_asc' ? ' selected' : ''}}>価格の安い順</option>
                        <option value="3"{{ Request::get('sort') == 'price_desc' ? ' selected' : ''}}>価格の高い順</option>
                    </select>
                </dd>
            </dl>
